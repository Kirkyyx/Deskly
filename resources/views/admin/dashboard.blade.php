                            ...
                            <tr>
                                ...
                                <td>
                                    @if($ticket->technician)
                                        <div class="user-name">
                                            <div class="user-avatar" style="background: linear-gradient(135deg, #10b981, #3b6ef8);">{{ strtoupper(substr($ticket->technician->name, 0, 1)) }}</div>
