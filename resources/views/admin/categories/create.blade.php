...
<style>
    ...
    .btn-cancel:hover { background: #ede9fe; color: var(--text-primary); }
...
<div class="page-wrap">
    <div class="form-wrap">
        ...
        <div class="page-title">
            <h2>Add Category</h2>
            <p>Create a new ticket category.</p>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <div class="card-section-label">Category Details</div>
                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" name="name" id="name" class="field-input"
                            value="{{ old('name') }}" required placeholder="e.g. Hardware, Network, Software…">
                        <div class="field-hint">This name will appear when users submit tickets.</div>
                    </div>
