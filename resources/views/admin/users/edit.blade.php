...
<style>
    ...
    .form-actions {
        ...
        gap: 0.65rem; margin-top: 1.75rem; padding-top: 1.5rem;
    ...
    .del-desc { font-size: 0.875rem; color: var(--text-dim); line-height: 1.6; margin-bottom: 1.25rem; }
    .del-desc strong { color: var(--text-primary); font-weight: 600; }

    .del-warning {
        background: #fffbeb; border: 1px solid #fde68a;
        border-radius: 8px; padding: 0.6rem 0.875rem;
        font-size: 0.775rem; color: #92400e; margin-bottom: 1.5rem; font-weight: 500;
    }
    ...
    .del-btn {
        ...
        transition: background 0.18s, transform 0.18s; letter-spacing: -0.01em;
    }
    ...
    .del-btn-confirm { background: var(--danger); color: #fff; box-shadow: 0 4px 14px rgba(239,68,68,0.25); }
...
<div class="page-wrap">
    <div class="form-wrap">
        ...
        <div class="page-title">
            <h2>Edit User</h2>
            <p>Update the name or access level for this account.</p>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form action="{{ route('users.update', $user) }}" method="POST">
                    ...
                    {{-- Strip badge suffix for the editable name field --}}
                    @php
                        $baseName = preg_replace('/\s*\(IT Staff #\d{4}\)$/', '', $user->name);
                    @endphp

                    <div class="field-group">
                        <label class="field-label">Name</label>
                        <input type="text" name="name" id="nameInput" class="field-input"
                               value="{{ old('name', $baseName) }}" required placeholder="Full name">
                        <div class="staff-badge-hint" id="staffBadgeHint">
                            A unique badge will be appended automatically —
                            e.g. <span class="badge-preview" id="badgePreview"></span>
                        </div>
                    </div>
